...
public class ConstraintElementGroup {
	...
	public ConstraintElement getFirstConstraitElement(){
		RelationName relationName = new ArrayList<RelationName>(constraintElements.keySet()).get(0);
		return constraintElements.get(relationName)[0];
	}
}
